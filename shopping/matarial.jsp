...
<script type="text/javascript" src="${contextPath}/resources/js/jquery-3.6.4.min.js"></script>
...
<link rel="stylesheet" href="${contextPath}/resources/css/matarial.css">
<link rel="shortcut icon" href="${contextPath}/resources/smalllogo.png" />
<script type="text/javascript" src="${contextPath}/resources/js/login.js"></script>
<script type="text/javascript" src="${contextPath}/resources/js/naver_login.js"></script>
<script type="text/javascript" src="${contextPath}/resources/js/kakao_login.js"></script>
<link rel="stylesheet" href="${contextPath}/resources/css/login.css">
<script type="text/javascript" src="${contextPath}/resources/js/matarial.js"></script>
			...
			<div class="today_recipe">
                ...
                <ul>
                    <c:forEach var="list" begin="0" end="2" items="${recipeList}">
                       <li>
                           <a href="${contextPath}/community/specific.do?recipeNo=${list.recipeNo}">
                               <img src="${contextPath}/download.do?imgName=${list.imgVO.imgName}&recipeNo=${list.recipeNo}" alt="레시피 베스트 이미지" width="100%" height="100%">
                           </a>
                           <a href="${contextPath}/community/specific.do?recipeNo=${list.recipeNo}">${list.recipeTitle}</a>
                       </li>   
                   </c:forEach>
                </ul>
            </div>
							...
							<c:forEach var="matarial" items="${matarialList}">
								<li><a
									href="${contextPath}/shopping/product_info.do?prodCode=${matarial.prodCode}">
										<img src="${contextPath}/resources/productImages/${matarial.prodImage}"
										alt="이미지">
								</a> <a
...
<script type="text/javascript"
	src="${contextPath}/resources/js/shopping_common.js"></script>
</html>