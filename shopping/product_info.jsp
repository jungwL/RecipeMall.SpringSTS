...
<c:set var="productList" value="${productInfoMap.productList[0]}"/>
...
<head>
    ...
    <script src="${contextPath}/resources/js/product_info.js"></script>
    <link rel="stylesheet" href="${contextPath}/resources/css/shopping_common.css">
    <link rel="stylesheet" href="${contextPath}/resources/css/product_info.css">
...
<body>
        ...
        <div id="main_content">
            ...
            <div class="product_area">
                   <div class="product_image">
                       <img src="${contextPath}/resources/productImages/${productList.prodImage}" alt="상품 이미지">
                   </div>
                   <div class="product">
            ...
            <div class="product_info_area">
               ...
               <div class="product_info product_info1">
                    ...
                    <div class="prodContentImage">
                       <img alt="" src="${contextPath}/resources/productImages/${productList.prodContentImage1}">
                       <img alt="" src="${contextPath}/resources/productImages/${productList.prodContentImage2}">
                    </div>
                </div>
                <div class="product_info product_info2">
                    <div class="product_info_top_area flex_area_rsb">
                        ...
                        <form action="${contextPath}/mypage/review/viewReview.do">
                ...
                <div class="product_info product_info3" >
                    ...
                    <form action="${contextPath}/shopping/addFaq.do" method="post">
                        <div class="write_qna_area">
                            ...
                            <input type="hidden" id="tempId" name="id" value="${log_id}">
   ...
   <jsp:include page="/WEB-INF/views/fix/login.jsp"/>     
    ...
    <script src="${contextPath}/resources/js/kakao_login.js"></script>
        ...
        <!-- [e]footer 영역 -->
        <script type="text/javascript" src="${contextPath}/resources/js/shopping_common.js"></script>
