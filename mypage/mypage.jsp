...
<script src="${contextPath}/resources/js/mypage_main.js"></script>
			...
			<div class="mypage_content">
				...
				<div class="moving_box">
					<div class="order_place">
						<img src="${contextPath}/resources/images/market.JPG" alt="market">
					</div>
					<div class="truck_img">
						<img src="${contextPath}/resources/images/truck.JPG" alt="truck">
					</div>
					<div class="order_home">
						<img src="${contextPath}/resources/images/house.JPG" alt="house">
					</div>
				</div>
