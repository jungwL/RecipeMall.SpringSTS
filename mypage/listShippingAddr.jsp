...
<script src="${contextPath}/resources/js/doro.js"></script>
<script src="${contextPath}/resources/js/mypage_2_3.js"></script>
<link rel="stylesheet" href="${contextPath}/resources/css/mypage_common.css">
<link rel="stylesheet" href="${contextPath}/resources/css/mypage.css">
<link rel="stylesheet" href="${contextPath}/resources/css/mypage_2_3.css">
<style type="text/css">
.shippingTable {
			...
			<div class="mypage_content">
				...
				<div class="mypage_content_address">
					...
					<p align="center" class="shippingAddbtn">
						<a href="${contextPath}/mypage/addShippingAddr.do">&lt; 배송지등록</a>
					</p>
				</div>
				<!-- mypage_content -->
			</div>
