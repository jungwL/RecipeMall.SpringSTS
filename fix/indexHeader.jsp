...
<header>
        ...
        <div class="header_top flex_area_rsb">
            ...
            <div>
                <ul class="mainmenu flex_area_rsb">
                    <li class="main" title="메인페이지로 이동" onclick="location.href='${contextPath}/main/index.do'"></li>
                    <li><a href="${contextPath}/main/index.do" class="a_community">커뮤니티</a></li>
            ...
            <div>
                <ul class="submenu">
					...
					<c:if test="${isLogon == true}">
						...
						<li><a href="">님</a></li>
	                    <li><a href="${contextPath}/loginProc/logout.do" class="logout">로그아웃</a></li>
	                    <li><a href="${contextPath}/mypage/mypage.do?id=${user.id}" class="">마이페이지</a></li>
					</c:if>
					<c:if test="${isLogon != true}">
            ...
            <div class="btn_write_sub" hidden>
                ...
                <a class="a_btn_write" href="${contextPath}/free/notice_write.do">
                    <div class="btn_write_icon">
        ...
        <div class="header_bottom flex_area_rsb">
            ...
            <div class="flex_area_rsb">
                <ul class="category">
                    <li><a href="${contextPath}/community/recipe.do" class="a_community">레시피</a></li>
                    <li><a href="${contextPath}/community/best.do" class="a_community">베스트</a></li>
                    <li><a href="${contextPath}/community/free_board.do" class="a_community">자유게시판</a></li>
                </ul>
            </div>
            <!--[e]카테고리 영역 -->
